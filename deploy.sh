...
IMAGE_TAG=$(aws ssm get-parameter --name "docker-tag" --region ap-south-1 --query "Parameter.Value" --output text)

docker rm -f 270514764245.dkr.ecr.us-east-1.amazonaws.com/aura-app:latest || true

docker pull 270514764245.dkr.ecr.us-east-1.amazonaws.com/aura-app:$IMAGE_TAG
